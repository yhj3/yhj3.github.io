...
\item Reached 0.7575 foreground Dice with TransUNet against 0.7326 for the tuned U-Net under a fixed
      15-epoch budget (best-epoch validation); class-wise analysis localized the transformer's
      advantage to the diffuse tumor subregion (0.7652 vs.\ 0.6800) rather than to compact structures.
\end{itemize}

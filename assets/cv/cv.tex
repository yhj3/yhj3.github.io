...
\entry{Research Collaboration --- Prof. Hongying Zan, Zhengzhou University}{Aug 2024 -- present}{Method-specific paper recommendation for academic writing --- manuscript in preparation}
\begin{itemize}
\item Extended SPECTER embeddings beyond titles and abstracts to subsection titles and method
      descriptions, aligned them with sentence-level citation contexts, and built citation graphs
      over direct and multi-level links to refine the ranking.
\item Method-specific recommendation accuracy rose from 47\% to 65\% over the baseline, judged by
      student raters using the system in their own research.
\end{itemize}
...
\item Curated 10,395 papers and 497,210 citation contexts from LaTeX sources; augmenting candidates
      with in-link context --- how a paper is used by others --- raised MRR from 0.485 to 0.572 at $K=5$.
\end{itemize}
